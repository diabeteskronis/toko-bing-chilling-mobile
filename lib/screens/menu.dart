...
class MyHomePage extends StatelessWidget {
  ...
  final String price = '16000';
  final String description = 'lorem ipsum';
  final String rating = '10';
  final List<ItemHomepage> items = [
    ItemHomepage("Lihat Es Krim", Icons.shopping_cart, Colors.pink.shade400),
    ItemHomepage("Tambah Es Krim", Icons.add, Colors.pink.shade300),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Bing Chilling" dengan teks putih dan tebal.
        title: const Text(
          'Bing Chilling',
          style: TextStyle(
            color: Colors.white,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            // Row untuk menampilkan 4 InfoCard secara horizontal.
            Row(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Welcome to Bing Chilling Creamery',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
                  ...
                  GridView.count(
                    ...
                    children: items.map((ItemHomepage item) {
                      return ItemCard(item, item.color);
                    }).toList(),
                  ),
                ],
              ),
